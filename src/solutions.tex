...
microtype,pgfplots,tikz,enumerate,mathtools}
...
\newcommand*{\beautyBr}{\smallskip\flushleft} % * prevents paragraph tokens (cannot accept \par)
...
\newenvironment{propertym}%
{%
    \begin{center}%
    \begin{minipage}{0.85\linewidth}\raggedright%
}%
{%
    \end{minipage}%
    \end{center}%
